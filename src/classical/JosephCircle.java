 ...
 * @idea: 约瑟夫环 约瑟夫环（约瑟夫问题）是一个数学的应用问题：已知n个人（以编号1，2，3...n分别表示）围坐在一张圆桌周围。
...
public class JosephCircle {
	...
	/**
	 * @Title: joseph @Description: 输出依次出列的编号，以及最后安全的那些编号 @throws
	 */
	...
	/**
	 * 约瑟夫最后剩下的编号简单算法： oldNo表示长度为i个数时， 报数最后剩下的编号 newNo表示长度为i-1个数时，报数最后剩下的编号
	 */
